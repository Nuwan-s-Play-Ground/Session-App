...
<form action="signin.jsp" method="post" class="p-2 text-center border p-4 rounded">
    <h1 class="text-center">Session App</h1>
    <div class="mb-3">
        <label for="txt-email" class="form-label">Email address</label>
        <input type="email" class="form-control" id="txt-email" placeholder="Enter your email">
    </div>

    <div class="mb-3">
        <label for="txt-password" class="form-label">Password</label>
        <input type="email" class="form-control" id="txt-password" placeholder="Enter your password">
    </div>
    <div>
